...
func allTools() []toolSpec {
	return []toolSpec{
		...
		{"run_complete", []string{ProfileExecutor}, TierCore, registerRunComplete},
		{"run_fail", []string{ProfileExecutor}, "", registerRunFail},
		{"run_cancel", []string{ProfileExecutor}, "", registerRunCancel},
